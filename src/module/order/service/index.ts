...
export class OrderService implements IOrderService {
    ...
    async getAllOrderCreatedBetweenTime (startDate: Date, endDate: Date) : Promise<Order[]> {
        const result = await this.orderRepository.getAllOrderCreatedBetweenTime(startDate, endDate);
        return result;
    }
    ...
    async getAllOrderDeliveredBetweenTime (startDate: Date, endDate: Date) : Promise<Order[]> {
        const result = await this.orderRepository.getAllOrderDeliveredBetweenTime(startDate, endDate);
        return result;
    }
    async getAllOrderCompletedBetweenTime (startDate: Date, endDate: Date) : Promise<Order[]> {
        const result = await this.orderRepository.getAllOrderCompletedBetweenTime(startDate, endDate);
        return result;
    }
