...
export class ProductItemService implements IProductItemService {
  ...
  async update(
    ...
    return (await this.productItemRepository.update(
      id,
      updatedForm
    )) as ProductItem;
  }
  async updateQuantity(
    ...
    return (await this.productItemRepository.updateQuantity(
      id,
      quantity
    )) as ProductItem;
  }
  ...
  async getByNameAdmin(nameProductItem: string): Promise<ProductItem[] | null> {
    const result = await this.productItemRepository.findByNameAdmin(
      nameProductItem
    );
    return result;
  }
  ...
  async getAllProductItemInactive(): Promise<ProductItem[]> {
    const result =
      await this.productItemRepository.findAllProductItemInactive();
    return result;
  }
  ...
  async getAllProductItemByBrandId(
    ...
    const result = await this.productItemRepository.findAllProductItemByBrandId(
      brandId
    );
    return result;
  }
  async getAllProductItemByCateId(
    ...
    const result = await this.productItemRepository.findAllProductItemByCateId(
      cateId
    );
    return result;
  }
  async getAllProductItemByProductId(
    ...
    const result =
      await this.productItemRepository.findAllProductItemByProductId(productId);
    return result;
  }
  async getAllProductItemBySizeId(
    sizeId: string
  ): Promise<ProductItem[] | null> {
    const result = await this.productItemRepository.findAllProductItemBySizeId(
      sizeId
    );
    return result;
  }
  async getAllProductItemByColorId(
    ...
    const result = await this.productItemRepository.findAllProductItemByColorId(
      colorId
    );
    return result;
  }
