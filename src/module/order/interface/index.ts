...
import { DraftOrder, Order, DateRangeForm} from "../model";
...
export interface IOrderRepository{
    ...
    getAllOrderCreatedBetweenTime : (startDate: Date, endDate: Date) => Promise<Order[]>
    getAllOrderShippedBetweenTime : (startDate: Date, endDate: Date) => Promise<Order[]>
    getAllOrderDeliveredBetweenTime : (startDate: Date, endDate: Date) => Promise<Order[]>
    getAllOrderCompletedBetweenTime : (startDate: Date, endDate: Date) => Promise<Order[]>
